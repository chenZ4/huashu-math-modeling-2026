...
面积利用率 $\eta = \dfrac{\Sigma A}{\text{side}^2}$。由题目公式(1)
$\text{side} = \lceil \sqrt{\Sigma A\,(1+d)}\,\rceil$ 可得 $\text{side}^2 \ge \Sigma A(1+d)$，
故利用率存在\textbf{严格上界}：
...
（$\lceil\cdot\rceil$ 只会使 $\text{side}$ 更大，上界随之更紧。）实测三芯片
0.867$\sim$0.868，与上界差距 $<0.3\%$——布局紧凑度逼近公式(1)决定的理论极限。
