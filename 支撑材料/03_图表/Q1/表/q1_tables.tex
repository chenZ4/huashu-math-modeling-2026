...
\section{多种子快速模拟退火求解结果（不同种子数取优，$\lambda=0.5$）}

\textbf{独立轮次数 = 独立随机种子数}：每种种子数下并行独立退火、
取 $(A, R)$ 字典序最优。表中面积与长宽比并列，加粗为定稿采用值。
...
\toprule
芯片 & 指标 & 4 种子 & 8 种子 & 12 种子 & 16 种子 & 24 种子 \\
\midrule
\multirow{2}{*}{n100} & 面积 & 193697 & \textbf{189198} & 189198 & 189198 & 189198 \\
 & 长宽比 & 1.1356 & \textbf{1.1039} & 1.1039 & 1.1039 & 1.1039 \\
\midrule
\multirow{2}{*}{n200} & 面积 & -- & 183742 & -- & 183742 & \textbf{183708} \\
 & 长宽比 & -- & 1.2592 & -- & 1.2592 & \textbf{1.2857} \\
\midrule
\multirow{2}{*}{n300} & 面积 & -- & -- & -- & \textbf{285228} & -- \\
 & 长宽比 & -- & -- & -- & \textbf{1.6403} & -- \\
\bottomrule
\end{tabular}
\end{table}

注：n100 在 8 种子即收敛至 189198（4 种子为 193697），此后不再改善；
n200 在 24 种子有 $<0.1\%$ 级改善（183742$\to$183708，t2=20 下）；
n300 仅扫描 16 种子（赛程限制）。多种子取优用于对抗单次退火的
随机波动，定稿轮数为 8（n100）与 24（n200/n300）。
