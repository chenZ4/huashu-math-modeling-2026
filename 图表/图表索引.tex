...
model\_\allowbreak{}assumptions.pdf/.tex & 模型假设章节成稿（通用假设 + 四问分别假设 + 敏感性说明表） & 直接引用/微调 \\
appendix\_\allowbreak{}core\_\allowbreak{}methods.pdf/.tex & 核心算法与方法实现附录（B*-Tree/解码/扰动/SA/二分确认/超块穷举 + 伪代码与复杂度） & 正文后附件 \\
\bottomrule
\end{tabular}
\end{table}
